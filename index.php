		...
		<nav class="navbar main-menu-cont">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="http://apartment-html.chart.civ.pl/index.html" title="" class="navbar-brand">
						<img src="http://apartment-html.chart.civ.pl/images/logo-light.png" alt="Apartment - Premium Real Estate Template" />
					</a>
				</div>
								...
								<div class="slide-desc">
									...
									<div class="slide-desc-params">	
										<div class="slide-desc-area">
											<img src="http://apartment-html.chart.civ.pl/images/area-icon.png" alt="" />457m<sup>2</sup>
										</div>
										<div class="slide-desc-rooms">
											<img src="http://apartment-html.chart.civ.pl/images/rooms-icon.png" alt="" />9
										</div>
										<div class="slide-desc-baths">
											<img src="http://apartment-html.chart.civ.pl/images/bathrooms-icon.png" alt="" />3
										</div>	
										<div class="slide-desc-parking">
											<img src="http://apartment-html.chart.civ.pl/images/parking-icon.png" alt="" />2
										</div>	
									</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-lg-12 text-center">
					<h5 class="subtitle-margin">learn more about this</h5>
							<h1 class="">luxury villa<span class="special-color">.</span></h1>
				</div>
		...
		<div class="container margin-top-60">
			<div class="row">
				<div class="col-xs-12 col-sm-10 col-md-8 col-sm-offset-1 col-md-offset-2 text-center">
					<p class="negative-margin">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
					Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
		...
		<div class="neighbourhood-container">
			<div class="owl-carousel" id="neighbourhood-owl">
				<div class="neighbourhood-col">
					<div class="neighbourhood-item">
						<div class="neighbourhood-photo">
							<img src="http://apartment-html.chart.civ.pl/images/near1.jpg" alt="" />
						</div>
				...
				<div class="neighbourhood-col">
					<div class="neighbourhood-item">
						<div class="neighbourhood-photo">
							<img src="http://apartment-html.chart.civ.pl/images/near2.jpg" alt="" />
						</div>
						<div class="neighbourhood-text">
				...
				<div class="neighbourhood-col">
					<div class="neighbourhood-item">
						<div class="neighbourhood-photo">
							<img src="http://apartment-html.chart.civ.pl/images/near3.jpg" alt="" />
						</div>
						<div class="neighbourhood-text">
				...
				<div class="neighbourhood-col">
					<div class="neighbourhood-item">
						<div class="neighbourhood-photo">
							<img src="http://apartment-html.chart.civ.pl/images/near4.jpg" alt="" />
						</div>
						<div class="neighbourhood-text">
				...
				<div class="neighbourhood-col">
					<div class="neighbourhood-item">
						<div class="neighbourhood-photo">
							<img src="http://apartment-html.chart.civ.pl/images/near5.jpg" alt="" />
						</div>
						<div class="neighbourhood-text">
				...
				<div class="neighbourhood-col">
					<div class="neighbourhood-item">
						<div class="neighbourhood-photo">
							<img src="http://apartment-html.chart.civ.pl/images/near6.jpg" alt="" />
						</div>
						<div class="neighbourhood-text">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-6 small-cont">
					<img src="http://apartment-html.chart.civ.pl/images/logo-light.png" alt="" class="img-responsive footer-logo" />
				</div>
				<div class="col-xs-12 col-md-6 footer-copyrights">
					&copy; Copyright 2015 <a href="http://themeforest.net/user/johnnychaos?ref=johnnychaos" target="blank">Touchdevs</a>. All rights reserved.<a href="http://touchdevs.com" target="blank">Touchdevs</a>.
				</div>
			</div>
		</div>
	</footer>
...
<!-- google maps initialization -->
	<script type="text/javascript">
			...
			function init() {
				mapInit(41.6926,-87.6021,"contact-map1","http://apartment-html.chart.civ.pl/images/pin-contact.png", true, true);
			}
	</script>
